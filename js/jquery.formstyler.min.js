  ...
  ;(t.prototype = {
    init: function () {
      ...
      var i = e(this.element),
        ...
        a = !(
          !navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/(Windows\sPhone)/i)
        )
      if (i.is(':checkbox')) {
        var d = function () {
          var s = new t(),
            l = e('<div class="jq-checkbox"><div class="jq-checkbox__div"></div></div>')
        ...
        var r = function () {
          var s = new t(),
            l = e('<div class="jq-radio"><div class="jq-radio__div"></div></div>')
              .attr({ id: s.id, title: s.title })
              .addClass(s.classes)
              .data(s.data)
          i.after(l).prependTo(l),
          ...
          function r() {
            for (var e = 0; e < c.length; e++) {
              ...
              t.prop('selected') && (i = 'selected sel'),
                ...
                void 0 !== t.attr('class') &&
                  ((f = ' ' + t.attr('class')), (u = ' data-jqfs-class="' + t.attr('class') + '"'))
              var p = t.data()
              ...
              i + f !== '' && (o = ' class="' + i + f + '"'),
                ...
                t.parent().is('optgroup') &&
                  ...
                  t.is(':first-child') &&
                    (s =
                      '<li class="optgroup' + h + '">' + t.parent().attr('label') + '</li>' + s)),
                (n += s)
            }
          }
          var c = e('option', i),
          ...
          if (i.is('[multiple]')) {
              ...
              void 0 !== f && f > 0 ? o.css({ height: u * f }) : o.css({ height: 4 * u }),
                h > l.height() &&
                  ...
                  a.filter('.selected').length &&
                    o.scrollTop(o.scrollTop() + a.filter('.selected').position().top)),
                i.prependTo(l),
                i.is(':disabled')
                  ? (l.addClass('disabled'),
                    c.each(function () {
                    ...
                    h > l.height() &&
                      i.on('keydown.styler', function (e) {
                        ;(38 != e.which && 37 != e.which && 33 != e.which) ||
                          o.scrollTop(o.scrollTop() + a.filter('.selected').position().top - u),
            ...
            !(function () {
              ...
              var A = b.outerHeight(!0),
                ...
                K = j.filter('.selected')
              if (
                (K.length < 1 && j.first().addClass('selected sel'), void 0 === j.data('li-height'))
              ) {
                var O = j.outerHeight()
              ...
              x.click(function () {
                if (
                  (e('div.jq-selectbox').filter('.opened').length &&
                    l.onSelectClosed.call(e('div.jq-selectbox').filter('.opened')),
                  i.focus(),
                  !o)
                ) {
                  var t = e(window),
                  ...
                  .on('keydown.styler keyup.styler', function (e) {
                    ...
                    '' === i.val()
                      ...
                      j
                        ...
                        .eq(i[0].selectedIndex)
                        .addClass('selected sel'),
                      (38 != e.which && 37 != e.which && 33 != e.which && 36 != e.which) ||
                        ('' === i.val()
                          ? _.scrollTop(0)
                          : _.scrollTop(_.scrollTop() + j.filter('.selected').position().top)),
                      (40 != e.which && 39 != e.which && 34 != e.which && 35 != e.which) ||
                        _.scrollTop(
                          _.scrollTop() + j.filter('.selected').position().top - _.innerHeight() + t
                        ),
                      13 == e.which &&
                        (e.preventDefault(),
                        q.hide(),
